...
export default function Tecnologia() {
    return (
        <div className='bg-[url(./assets/ondas.png)] bg-no-repeat p-10 bg-cover bg-center grid grid-rows-3 md:grid-rows-1 md:pb-40  md:grid-cols-3 gap-4 xl:px-60 md:pt-30'>
            <div className='bg-gray-950 w-auto pt-10 rounded-lg content-center'>
                <img className='m-auto' src={Foto} alt="" />
            </div>
            <div className='bg-gray-950 row-span-3 md:col-span-2 p-5 md:p-12 text-center md:text-left rounded-lg'>
